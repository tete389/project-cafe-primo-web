...
export default function DialogEditMaterialUse(params) {
  const { idIsUsed, materialUse, closeEdit, sendUpdateMateUsed } = params;
    ...
    <div className="modal-box w-max">
      ...
      <div>
        <ul className="w-56 menu bg-base-200 rounded-box">
          <li>
            <p className="menu-title">แก้ไขส่วนผสม</p>
            <ul>
